...
namespace Microsoft.Teams.Apps.GoodReads.Controllers
{
    ...
    public class PostController : BaseGoodReadsController
    {
        ...
        {
            this.logger.LogInformation("Error while adding new post.");
...
#pragma warning restore CA1062 // Validation is done using data annotations
            {
                this.logger.LogError($"PostId is either null or empty to update post detail.");
                this.RecordEvent("Update post - HTTP Put call failed");

                return this.BadRequest("PostId cannot be null or empty.");
            }
            ...
            if (postDetails.UserId != this.UserAadId)
            {
                ...
                return this.NotFound($"User did not create any post with post Id: {postDetails.PostId}.");
            }
            ...
            try
            {
                ...
                if (currentPost == null || currentPost.IsRemoved)
                {
                    ...
                    return this.BadRequest($"Could not find post {postDetails.PostId} to update.");
                }
        ...
        public async Task<IActionResult> DeleteAsync(string postId)
        {
            ...
            try
            {
                ...
                if (postDetails == null)
                {
                    ...
                    return this.BadRequest($"Cannot find post {postId} created by user {this.UserAadId} for deletion.");
                }
